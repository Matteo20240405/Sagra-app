...
# --- 4. STEP 3: DOWNLOAD RICEVUTA ---
    ...
    pdf.multi_cell(0, 7, "Si prega di conservare questa ricevuta e di allegare la copia del bonifico/transazione PayPal effettuata. Presentare entrambi ai camerieri dopo che vi sarete seduti ai tavoli.")
